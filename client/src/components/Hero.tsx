...
export default function Hero() {
    ...
    return (
        <div className="text-center min-h-[100vh] flex flex-col items-center">
            ...
            <button className="my-15 shadow-xl hover:scale-110 transition-all duration-250">
                <a href="#project" className="bg-[url('/bg.jpg')] rounded-xl py-2 px-5 font-medium text-xl">Project</a>
            </button>
        </div>
    )
}