...
const config = {
    ...
    projects: [
        ...
        { name: 'Zerowave Profile Company', description: "The Zerowave website is created to showcase the company's profile, highlighting the company's strengths to enhance client trust and corporate credibility. The website includes a page dedicated to displaying the list of ongoing projects, as well as those that have been successfully completed. This aims to provide a comprehensive overview of the company's capabilities and accomplishments.", img: '/projects/zerowave.jpg', tools: ['NextJS', 'TailwindCSS', 'Framer Motion'] },
        {name : 'Routine Waveform Download', description : 'This website is designed to streamline the process of backing up earthquake waveforms. With the existence of this website, it significantly reduces repetitive tasks that would typically take up to 30 minutes to just a few seconds. Users can simply click a button, and all the tasks are completed instantly.', img : '/projects/routine_download_waveform.jpg', tools : ['JavaScript', 'CSS', 'HTML5']}
